...
HD_PWD='U:/ENSC452/FinalStage/adventures_with_ip/adventures_with_ip.runs/ip_design_vga_controller_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_design_vga_controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ip_design_vga_controller_0_0.tcl
