...
HD_PWD='C:/Users/jrm22/Desktop/Zynq_book/adventures_with_ip.runs/ip_design_proc_sys_reset_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ip_design_proc_sys_reset_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ip_design_proc_sys_reset_0_0.tcl
